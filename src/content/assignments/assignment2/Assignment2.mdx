...
<p><AssignmentLink linkName='linkCanvasAssignment2b' /></p>
...
<AssignmentSamples milestone='assignment2b' />
...
<p><AssignmentLink linkName='linkCanvasAssignment2c' /></p>
...
<AssignmentSamples milestone='assignment2c' />
...
- Design research findings and themes (less than two pages).
...
<p><AssignmentLink linkName='linkCanvasAssignment2d' /></p>
...
<AssignmentSamples milestone='assignment2d' />
...
Each task should concisely convey a problem and what is accomplished,
then might provide further detail in a step-by-step walkthrough of one or more scenarios with specific designs.
For example, tasks might be presented as a bolded sentence at the beginning of a paragraph,
with additional details and potential scenarios presented in the remainder of the paragraph.
...
<p><AssignmentLink linkName='linkCanvasAssignment2e' /></p>
...
<AssignmentSamples milestone='assignment2e' />
...
{/*
  ...
  *
  */}
<CollapseProjectMilestone heading='2f: Design Check-In ("3x4")' dueDateName='dueDateAssignment2f' revisionDueDateName='dueDateAssignment2f_revised'>
...
<p><AssignmentLink linkName='linkCanvasAssignment2f' /></p>

After receiving critique on Thursday, submit an updated version via Canvas here:

<p><AssignmentLink linkName='linkCanvasAssignment2f_revised' /></p>
...
<AssignmentSamples milestone='assignment2f' />
...
show insight into the task/design, and include one or more characters and settings.
The storyboards should not include any unneeded frames or unneeded details across multiple frames.
...
<p><AssignmentLink linkName='linkCanvasAssignment2g' /></p>
...
<AssignmentSamples milestone='assignment2g' />
</CollapseProjectMilestone>
...
<p><AssignmentLink linkName='linkCanvasAssignment2p' /></p>
...
<AssignmentSamples milestone='assignment2p' />
</CollapseProjectMilestone>
