...
{/*
  ...
  *
  */}
<CollapseProjectMilestone milestone={'assignment3a'}>
...
It should be complete for each task. This means it should include enough detail to show how to get from beginning to end 
for each task in the desired/intended path and some error conditions 
(e.g., what happens if a participant clicks the wrong button?).
It should be an appropriate level of detail to understand all aspects of the design.
The documentation in your report should explain how all the parts are related to each other.
One way to do this is to include the sequence of steps in your prototype.
...
<InformalDrawingTool />
If you use an informal drawing tool, you will have to print out a physical copy of your paper prototype.
...
<p><AssignmentCanvasLink milestone={'assignment3a'} /></p>
...
{/*
  ...
  *
  */}
<CollapseProjectMilestone milestone={'assignment3b'}>
...
{/*
  ...
  *
  */}
<CollapseProjectMilestone milestone={'assignment3c'}>
...
<p><AssignmentCanvasLink milestone={'assignment3c'} /></p>
...
{/*
  ...
  *
  */}
<CollapseProjectMilestone milestone={'assignment3d'}>
...
<p><AssignmentCanvasLink milestone={'assignment3d'} /></p>
...
{/*
  ...
  *
  */}
<CollapseProjectMilestone milestone={'assignment3e'}>
...
<p><AssignmentCanvasLink milestone={'assignment3e'} /></p>
...
{/*
  ...
  *
  */}
<CollapseProjectMilestone milestone={'assignment3p'}>
...
<p><AssignmentCanvasLink milestone={'assignment3p'} /></p>
