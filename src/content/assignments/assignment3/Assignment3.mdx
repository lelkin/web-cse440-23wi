...
- Discuss decisions and changes you made in implementing the digital mockup.
  - Present a list of least **three** changes you made.
  - Describe each change in a few sentences.
...
You may choose to not fully document minor changes, and you are only required to submit three, but be sure to document enough for these two goals.
