...
<InformalDrawingTool />
You need a physical copy of your paper prototype regardless of how you create it. So, if you use an informal drawing tool, you will have to print your paper prototype.
