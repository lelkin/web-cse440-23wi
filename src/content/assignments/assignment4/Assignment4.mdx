...
import {CourseInformationLink} from "src/components/CourseInformation";
...
Your post will be integrated into the course website via the <GeneratedLink href={"/projects"}>Projects</GeneratedLink> page,
...
You can and should express enthusiasm, but do not let that enthusiasm undermine the substance of your content.
...
2. __Problem and Design Overview__:
   ...
   You should likely include an image from or of your design to help build interest.
...
- See the repository README.md for basic guidance on using `yarn dev_serve` to run a local build of the website.
  This will dynamically update as you modify your content.

- Prior to opening your pull request, use `yarn prod_build` to ensure that your code builds without errors.

- All edits included in your pull request should be contained within your provided project directory:

  - Edit the provided `project_post.mdx` file with the contents of your post.
  - Place images in the provided `assets` directories (i.e., for pictures of your team and for pictures used in your post).
...
Your poster should be complete for critique and feedback, but only the final version will be graded. Points will be deducted from the final poster score if this version is not complete enough to support feedback.
